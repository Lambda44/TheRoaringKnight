...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(RKMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(RKMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(RKMod.makeImagePath("masks/PowerMask.png"));
