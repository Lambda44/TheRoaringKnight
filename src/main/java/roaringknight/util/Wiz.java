...
public class Wiz {
    ...
    public static void applyToEnemyFast(AbstractMonster m, AbstractPower po) {
        atb(new ApplyPowerAction(m, AbstractDungeon.player, po, po.amount, true));
    }
    ...
    public static void playAudioV(ProAudio a, float mod) {
        CardCrawlGame.sound.playV(makeID(a.name()), mod);
    }
