...
public class SOULCrystalPower extends AbstractEasyPower {
    public static final String POWER_ID = makeID("SOULCrystal");
    ...
    public SOULCrystalPower(AbstractCreature owner, int amount) {
