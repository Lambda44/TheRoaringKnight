...
public class StarStormPower extends AbstractEasyPower {
    public static final String POWER_ID = makeID("StarStorm");
    ...
    public StarStormPower(AbstractCreature owner, int amount) {
    ...
    public void atStartOfTurn() {
        if (!AbstractDungeon.getMonsters().areMonstersBasicallyDead()) {
            this.flash();
            makeInHand(new Star(), this.amount);
        }
    }
