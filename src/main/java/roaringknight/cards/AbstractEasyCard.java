...
import roaringknight.util.CardArtRoller;

import static roaringknight.RKMod.makeImagePath;
import static roaringknight.RKMod.modID;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, RoaringKnight.Enums.KNIGHT_COLOR);
    }
    ...
    protected void blckFast() {
        atb(new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, block, true));
    }
